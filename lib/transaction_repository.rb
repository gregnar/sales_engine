...
class TransactionRepository < Repository
  ...
  def find_all_by_credit_card_number(arg)
    find_all_by(:credit_card_number, arg); end
  def find_all_by_credit_card_expiration_date(arg)
    find_all_by(:credit_card_expiration_date, arg); end
